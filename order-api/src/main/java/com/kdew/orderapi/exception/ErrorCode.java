...
public enum ErrorCode {
    ...
    ITEM_COUNT_NOT_ENOUGHE(HttpStatus.BAD_REQUEST, "상품에 수량이 부족합니다."),
    CART_CHANGE_FAIL(HttpStatus.BAD_REQUEST, "장바구니를 추가할 수 없습니다."),

    ORDER_FAIL_CHECK_CART(HttpStatus.BAD_REQUEST, "<주문불가> 장바구니를 확인해 주세요"),
